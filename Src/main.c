...
int main(void)
{
  ...
  while (1)
  {
    ...
    //Mensaje inicial 
		...
		//Ejecucion del selftest del STM32
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, LED1_Pin|LED2_Pin|CC32_RESET_Pin|RTS_MCU_CTS_VISOR_TTL_Pin
                          |PS_SD1_Pin|SDIO_EJ_RST_Pin|LED2MCU_Pin|LED1MCU_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : CC32_RESET_Pin RTS_MCU_CTS_VISOR_TTL_Pin SDIO_EJ_RST_Pin LED2MCU_Pin
                           LED1MCU_Pin */
  GPIO_InitStruct.Pin = CC32_RESET_Pin|RTS_MCU_CTS_VISOR_TTL_Pin|SDIO_EJ_RST_Pin|LED2MCU_Pin
                          |LED1MCU_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
